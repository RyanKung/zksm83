...
/// Pure SM83 step relation for `sm83-core-v1`.
...
/// Poseidon-v2 ROM root that enables the Pokémon Blue sound-wait summary.
pub const BLUE_SOUND_WAIT_ROM_ROOT: [u8; 32] = [
    0xa3, 0x9c, 0x94, 0x59, 0x55, 0x8f, 0xc9, 0xe8, 0xc9, 0xf9, 0x6d, 0xb3, 0x52, 0xd7, 0x23, 0x02,
    0x4c, 0xd2, 0x93, 0xd1, 0xdc, 0x97, 0x91, 0x8e, 0x79, 0xc9, 0xa7, 0x85, 0xb8, 0xa4, 0xda, 0x2c,
];
